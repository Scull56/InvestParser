...
class SideBar(ctk.CTkFrame):
   def __init__(self, master):
      ...
      instruction_btn.grid(row=6, column=0, sticky="w", pady=(0, 10))
      
      # Logging
      instruction_btn = ctk.CTkButton(body, text="Logging", command=self.open_logs)
      instruction_btn.grid(row=7, column=0, sticky="w")
   ...
   def open_instruction(self):
      ...
      storage['app'].open_instruction_window()
      
   def open_logs(self):
      
      storage['app'].open_logs_window()